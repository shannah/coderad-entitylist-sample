 ...
 * @author Shai Almog
 */
public class EntityListTestStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "EntityListTest";
    ...
    private EntityListTest mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new EntityListTestStub());
    }
